...
class C0295d extends C0294g {
    C0295d() {
    }

    private File m1481a(ParcelFileDescriptor parcelFileDescriptor) {
        try {
    ...
    public android.graphics.Typeface mo208a(android.content.Context r8, android.os.CancellationSignal r9, android.support.v4.p017f.C0323b.C0322b[] r10, int r11) {
        /*
        r7 = this;
        r0 = 0;
        r1 = r10.length;
    ...
    L_0x0005:
        return r0;
    L_0x0006:
        r1 = r7.m1480a(r10, r11);
        r2 = r8.getContentResolver();
        r1 = r1.m1545a();	 Catch:{ IOException -> 0x0056 }
        r3 = "r";
        r3 = r2.openFileDescriptor(r1, r3, r9);	 Catch:{ IOException -> 0x0056 }
        r2 = 0;
        r1 = r7.m1481a(r3);	 Catch:{ Throwable -> 0x0048, all -> 0x005c }
    ...
    L_0x0025:
        ...
        r5 = 0;
        r1 = super.m1479a(r8, r4);	 Catch:{ Throwable -> 0x0068, all -> 0x009c }
