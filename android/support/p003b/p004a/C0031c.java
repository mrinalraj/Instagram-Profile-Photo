...
public class C0031c extends C0030h implements C0025b {
    ...
    public void applyTheme(Theme theme) {
        if (this.b != null) {
            C0279a.m1422a(this.b, theme);
        }
    }

    public boolean canApplyTheme() {
        return this.b != null ? C0279a.m1429d(this.b) : false;
    }
    ...
    public int getAlpha() {
        return this.b != null ? C0279a.m1428c(this.b) : this.f60c.f53b.getAlpha();
    }
        ...
        while (eventType != 1 && (xmlPullParser.getDepth() >= depth || eventType != 3)) {
            if (eventType == 2) {
                ...
                if ("animated-vector".equals(name)) {
                    a = C0270d.m1360a(resources, theme, attributeSet, C0024a.f43e);
    ...
    public boolean isAutoMirrored() {
        return this.b != null ? C0279a.m1426b(this.b) : this.f60c.f53b.isAutoMirrored();
    }
