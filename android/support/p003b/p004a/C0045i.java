...
public class C0045i extends C0030h {
    ...
    private static class C0038d {
        ...
        public C0038d(C0038d c0038d) {
            ...
            this.f69m = C0291b.m1462a(c0038d.f69m);
        }

        public void m78a(Path path) {
            path.reset();
            if (this.f69m != null) {
                C0290b.m1454a(this.f69m, path);
            }
        }
        ...
        public void setPathData(C0290b[] c0290bArr) {
            if (C0291b.m1460a(this.f69m, c0290bArr)) {
                C0291b.m1463b(this.f69m, c0290bArr);
            } else {
                this.f69m = C0291b.m1462a(c0290bArr);
            }
        }
    }
    ...
    private static class C0039a extends C0038d {
        ...
        private void m80a(TypedArray typedArray) {
            ...
            if (string != null) {
                this.m = C0291b.m1464b(string);
            }
        }

        public void m81a(Resources resources, AttributeSet attributeSet, Theme theme, XmlPullParser xmlPullParser) {
            if (C0270d.m1363a(xmlPullParser, "pathData")) {
                TypedArray a = C0270d.m1360a(resources, theme, attributeSet, C0024a.f42d);
                m80a(a);
                a.recycle();
            }
        }
    ...
    private static class C0040b extends C0038d {
        ...
        private void m85a(TypedArray typedArray, XmlPullParser xmlPullParser) {
            ...
            if (C0270d.m1363a(xmlPullParser, "pathData")) {
                ...
                this.f74c = C0270d.m1364b(typedArray, xmlPullParser, "fillColor", 1, this.f74c);
                this.f77f = C0270d.m1358a(typedArray, xmlPullParser, "fillAlpha", 12, this.f77f);
                this.f81j = m83a(C0270d.m1359a(typedArray, xmlPullParser, "strokeLineCap", 8, -1), this.f81j);
                this.f82k = m84a(C0270d.m1359a(typedArray, xmlPullParser, "strokeLineJoin", 9, -1), this.f82k);
                this.f83l = C0270d.m1358a(typedArray, xmlPullParser, "strokeMiterLimit", 10, this.f83l);
                this.f72a = C0270d.m1364b(typedArray, xmlPullParser, "strokeColor", 3, this.f72a);
                this.f75d = C0270d.m1358a(typedArray, xmlPullParser, "strokeAlpha", 11, this.f75d);
                this.f73b = C0270d.m1358a(typedArray, xmlPullParser, "strokeWidth", 4, this.f73b);
                this.f79h = C0270d.m1358a(typedArray, xmlPullParser, "trimPathEnd", 6, this.f79h);
                this.f80i = C0270d.m1358a(typedArray, xmlPullParser, "trimPathOffset", 7, this.f80i);
                this.f78g = C0270d.m1358a(typedArray, xmlPullParser, "trimPathStart", 5, this.f78g);
                this.f76e = C0270d.m1359a(typedArray, xmlPullParser, "fillType", 13, this.f76e);
            }
        }

        public void m86a(Resources resources, AttributeSet attributeSet, Theme theme, XmlPullParser xmlPullParser) {
            TypedArray a = C0270d.m1360a(resources, theme, attributeSet, C0024a.f41c);
    ...
    private static class C0041c {
        ...
        public C0041c(C0041c c0041c, C0332a<String, Object> c0332a) {
            ...
            for (int i = 0; i < arrayList.size(); i++) {
                ...
                if (obj instanceof C0041c) {
                    this.f85a.add(new C0041c((C0041c) obj, c0332a));
                } else {
                    C0038d c0040b;
        ...
        private void m89a(TypedArray typedArray, XmlPullParser xmlPullParser) {
            this.f96l = null;
            this.f86b = C0270d.m1358a(typedArray, xmlPullParser, "rotation", 5, this.f86b);
            this.f89e = typedArray.getFloat(1, this.f89e);
            this.f90f = typedArray.getFloat(2, this.f90f);
            this.f91g = C0270d.m1358a(typedArray, xmlPullParser, "scaleX", 3, this.f91g);
            this.f92h = C0270d.m1358a(typedArray, xmlPullParser, "scaleY", 4, this.f92h);
            this.f93i = C0270d.m1358a(typedArray, xmlPullParser, "translateX", 6, this.f93i);
            this.f94j = C0270d.m1358a(typedArray, xmlPullParser, "translateY", 7, this.f94j);
            String string = typedArray.getString(0);
            if (string != null) {
                this.f97m = string;
            }
        ...
        public void m91a(Resources resources, AttributeSet attributeSet, Theme theme, XmlPullParser xmlPullParser) {
            TypedArray a = C0270d.m1360a(resources, theme, attributeSet, C0024a.f40b);
    ...
    private static class C0042e {
        ...
        int f104f;
        String f105g;
        final C0332a<String, Object> f106h;
    ...
    public static C0045i m111a(Resources resources, int i, Theme theme) {
        if (VERSION.SDK_INT >= 24) {
            ...
            c0045i.b = C0269c.m1356a(resources, i, theme);
    ...
    private void m113a(TypedArray typedArray, XmlPullParser xmlPullParser) {
        ...
        c0043f.f117d = C0045i.m110a(C0270d.m1359a(typedArray, xmlPullParser, "tintMode", 6, -1), Mode.SRC_IN);
        ColorStateList colorStateList = typedArray.getColorStateList(1);
        if (colorStateList != null) {
            c0043f.f116c = colorStateList;
        }
        c0043f.f118e = C0270d.m1362a(typedArray, xmlPullParser, "autoMirrored", 5, c0043f.f118e);
        c0042e.f102d = C0270d.m1358a(typedArray, xmlPullParser, "viewportWidth", 7, c0042e.f102d);
        c0042e.f103e = C0270d.m1358a(typedArray, xmlPullParser, "viewportHeight", 8, c0042e.f103e);
        if (c0042e.f102d <= 0.0f) {
            ...
            if (c0042e.f100b <= 0.0f) {
                ...
                c0042e.setAlpha(C0270d.m1358a(typedArray, xmlPullParser, "alpha", 4, c0042e.getAlpha()));
                String string = typedArray.getString(0);
                if (string != null) {
                    c0042e.f105g = string;
    ...
    private boolean m114a() {
        return VERSION.SDK_INT >= 17 ? isAutoMirrored() && C0279a.m1432g(this) == 1 : false;
    }
    ...
    public int getAlpha() {
        return this.b != null ? C0279a.m1428c(this.b) : this.f128c.f115b.getRootAlpha();
    }
    ...
    public void inflate(Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Theme theme) {
        if (this.b != null) {
            C0279a.m1423a(this.b, resources, xmlPullParser, attributeSet, theme);
            return;
        }
        C0043f c0043f = this.f128c;
        c0043f.f115b = new C0042e();
        TypedArray a = C0270d.m1360a(resources, theme, attributeSet, C0024a.f39a);
    ...
    public boolean isAutoMirrored() {
        return this.b != null ? C0279a.m1426b(this.b) : this.f128c.f118e;
    }
    ...
    public void setTintList(ColorStateList colorStateList) {
        if (this.b != null) {
            C0279a.m1421a(this.b, colorStateList);
            return;
        }
        C0043f c0043f = this.f128c;
