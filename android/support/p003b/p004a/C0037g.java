...
public class C0037g implements Interpolator {
    ...
    public C0037g(Resources resources, Theme theme, AttributeSet attributeSet, XmlPullParser xmlPullParser) {
        TypedArray a = C0270d.m1360a(resources, theme, attributeSet, C0024a.f50l);
    ...
    private void m76a(TypedArray typedArray, XmlPullParser xmlPullParser) {
        if (C0270d.m1363a(xmlPullParser, "pathData")) {
            String a = C0270d.m1361a(typedArray, xmlPullParser, "pathData", 4);
            Path a2 = C0291b.m1457a(a);
            if (a2 == null) {
                throw new InflateException("The path is null, which is created from " + a);
            }
            m77a(a2);
        } else if (!C0270d.m1363a(xmlPullParser, "controlX1")) {
            throw new InflateException("pathInterpolator requires the controlX1 attribute");
        } else if (C0270d.m1363a(xmlPullParser, "controlY1")) {
            float a3 = C0270d.m1358a(typedArray, xmlPullParser, "controlX1", 0, 0.0f);
            float a4 = C0270d.m1358a(typedArray, xmlPullParser, "controlY1", 1, 0.0f);
            boolean a5 = C0270d.m1363a(xmlPullParser, "controlX2");
            if (a5 != C0270d.m1363a(xmlPullParser, "controlY2")) {
                throw new InflateException("pathInterpolator requires both controlX2 and controlY2 for cubic Beziers.");
            } else if (a5) {
                m75a(a3, a4, C0270d.m1358a(typedArray, xmlPullParser, "controlX2", 2, 0.0f), C0270d.m1358a(typedArray, xmlPullParser, "controlY2", 3, 0.0f));
            } else {
                m74a(a3, a4);
            }
        } else {
